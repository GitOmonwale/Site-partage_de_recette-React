...
function Join_us() {
    return <>
        <section className="py-20 mt-10 bg-pink">
...
<p>By joinning our newsletter you agree to our <a href="" className='border-b-orange-400 border-b'>Terms and condition</a></p>
 </div>
        </section >
    </>
}
